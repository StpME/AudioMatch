...
def run_pyinstaller(spec_file):
    ...
    temp_dir = tempfile.mkdtemp(prefix="AudioMatch_")
...
def main():
    ...
    spec_file = os.path.join(src_dir, "AudioMatch.spec")
    ...
    exe_path = os.path.join(src_dir, "dist", f"AudioMatch_{version}.exe")
